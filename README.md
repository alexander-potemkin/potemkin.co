...
- Переменные `orange-color` и подобные содержатся в файле `_sass/_themes.scss`, но можно задавать цвета в файле `_sass/_themes.scss` напрямую: например, как `rgba(0,0,0,.1)` или `#42b983`
